...
- placeOdds: 複勝オッズ(数値のみ。「2.1-2.8」のような範囲表示の場合は低い方の数値。記載が無ければnull)
...
形式: {"raceName":"レース名またはnull","trackCondition":"良"または null,"paddockPicks":[3,7],"horses":[{"number":1,"frameNumber":1,"name":"馬名","jockey":"騎手名","jockeyRating":"普通","odds":4.5,"placeOdds":1.8,"popularity":3}]}`;
